...
_writebytehandler_receiver_65536_99:
	.ds 3
_writebytehandler_dataentry_65538_104:
	.ds 4
_randomread_handler_receiver_65536_106:
	.ds 3
_output::
	.ds 1
;--------------------------------------------------------
...
;address                   Allocated with name '_writebytehandler_address_65537_103'
;dataentry                 Allocated with name '_writebytehandler_dataentry_65538_104'
;data                      Allocated with name '_writebytehandler_data_65539_105'
;------------------------------------------------------------
...
;	main.c:67: uint8_t blockno=(t & 0xE00)>>8;
	mov	a,#0x0e
	anl	a,r7
;	main.c:69: printf("block no. is %d\n\r",blockno);
	mov	r5,a
	mov	r3,a
	mov	r4,#0x00
	push	ar7
	...
	pop	ar6
	pop	ar7
;	main.c:70: if(blockno<8)
	cjne	r5,#0x08,00110$
00110$:
	jnc	00102$
;	main.c:73: control |=blockno;
	mov	dptr,#_control
	movx	a,@dptr
	orl	a,r5
	movx	@dptr,a
;	main.c:74: printf("control %X\n\r",control);
	movx	a,@dptr
	mov	r5,a
	mov	r4,#0x00
	push	ar7
...
;	main.c:81: return;
	ljmp	_putstr
00103$:
;	main.c:84: uint8_t address=(t&0x0FF);
;	main.c:86: putstr("Enter data to be written\n\r");
	mov	dptr,#___str_3
	mov	b,#0x80
	push	ar6
	lcall	_putstr
;	main.c:88: gets(dataentry);
	mov	dptr,#_writebytehandler_dataentry_65538_104
	mov	b,#0x00
	lcall	_gets
;	main.c:90: data=strtohex(dataentry);
	mov	dptr,#_writebytehandler_dataentry_65538_104
	mov	b,#0x00
	lcall	_strtohex
	mov	r5,dpl
;	main.c:91: putstr(dataentry);
	mov	dptr,#_writebytehandler_dataentry_65538_104
	mov	b,#0x00
	push	ar5
	lcall	_putstr
	pop	ar5
	pop	ar6
;	main.c:92: byte_write(control,address,data);
	mov	dptr,#_control
	movx	a,@dptr
	mov	r7,a
...
;------------------------------------------------------------
;receiver                  Allocated with name '_randomread_handler_receiver_65536_106'
;t                         Allocated with name '_randomread_handler_t_65536_107'
;blockno                   Allocated with name '_randomread_handler_blockno_65537_108'
;address                   Allocated with name '_randomread_handler_address_131073_111'
;result                    Allocated with name '_randomread_handler_result_131073_111'
;------------------------------------------------------------
;	main.c:95: int randomread_handler(char *receiver)
;	-----------------------------------------
...
_randomread_handler:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_randomread_handler_receiver_65536_106
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
	...
	inc	dptr
	movx	@dptr,a
;	main.c:97: uint16_t t=strtohex(receiver);
	mov	dptr,#_randomread_handler_receiver_65536_106
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	mov	r6,dpl
	mov	r7,dph
;	main.c:98: printf("%s input address\n\r",receiver);
	push	ar7
	push	ar6
	mov	dptr,#_randomread_handler_receiver_65536_106
	movx	a,@dptr
	...
	pop	ar6
	pop	ar7
;	main.c:99: uint8_t blockno=(t & 0xE00)>>8;
	mov	a,#0x0e
	anl	a,r7
	mov	r5,a
;	main.c:100: if(blockno<7)
	cjne	r5,#0x07,00117$
00117$:
	jnc	00102$
;	main.c:103: control |=blockno;
	mov	dptr,#_control
	movx	a,@dptr
	orl	a,r5
	movx	@dptr,a
	sjmp	00103$
00102$:
;	main.c:108: errorflag=1;
	mov	dptr,#_errorflag
	mov	a,#0x01
	movx	@dptr,a
00103$:
;	main.c:109: if(errorflag)
	mov	dptr,#_errorflag
	movx	a,@dptr
	jz	00105$
;	main.c:111: putstr("Wrong block number. \n\r");
	mov	dptr,#___str_5
	mov	b,#0x80
	lcall	_putstr
;	main.c:112: return -1;
	...
	ret
00105$:
;	main.c:117: uint8_t address=(t&0x0FF);
;	main.c:118: int result =random_read(control,address);
	mov	dptr,#_control
	movx	a,@dptr
	mov	r7,a
...
;------------------------------------------------------------
;	main.c:126: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
;	main.c:128: i2c_reset();
	lcall	_i2c_reset
;	main.c:129: while(1)
00109$:
;	main.c:131: errorflag=0;
	mov	dptr,#_errorflag
	clr	a
	movx	@dptr,a
...
;	main.c:136: putstr("\n\r");
	...
	mov	b,#0x80
	lcall	_putstr
;	main.c:138: switch(toupper(menuselect))
	mov	dptr,#_menuselect
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
;	main.c:141: case 'W':
	sjmp	00109$
00101$:
;	main.c:142: putstr("ENTER ADDRESS TO BE WRITTEN ,ADDRESS INCLUDES BLOCK NUMBER AND WORD ADRRESS TOGETHER SEPERATED BY 0 in HEX\n\r");
	mov	dptr,#___str_8
	mov	b,#0x80
	lcall	_putstr
;	main.c:144: gets(addressreceiver);
	...
	mov	b,r7
	lcall	_gets
;	main.c:145: writebytehandler(addressreceiver);
	mov	dptr,#_addressreceiver
	movx	a,@dptr
	mov	r5,a
	inc	dptr
...
;	main.c:149: case 'R':
00102$:
;	main.c:150: putstr("ENTER ADDRESS TO BE READ,ADDRESS INCLUDES BLOCK NUMBER AND WORD ADRRESS TOGETHER SEPERATED BY 0 in HEX\n\r");
	mov	dptr,#___str_9
	mov	b,#0x80
	lcall	_putstr
;	main.c:151: gets(addressreceiver);
	mov	dptr,#_addressreceiver
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	mov	b,r7
	lcall	_gets
;	main.c:152: output=randomread_handler(addressreceiver);
	mov	dptr,#_addressreceiver
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	mov	a,r6
	movx	@dptr,a
;	main.c:153: if(errorflag==0)
	mov	dptr,#_errorflag
	movx	a,@dptr
	jnz	00104$
;	main.c:154: printf("Read value is 0x%X\n\r",output);
	mov	dptr,#_output
	movx	a,@dptr
	mov	r7,a
	mov	r6,#0x00
...
;	main.c:157: case 'S':
00105$:
;	main.c:160: seq_read(0xA0);
	mov	dpl,#0xa0
	lcall	_seq_read
;	main.c:161: control=0xA0;
	mov	dptr,#_control
	mov	a,#0xa0
	movx	@dptr,a
;	main.c:163: break;
...
;	main.c:164: case 'X':
00106$:
;	main.c:165: restart_i2c();
	lcall	_restart_i2c
;	main.c:166: i2c_write(0xFF);
	mov	dptr,#0x00ff
	lcall	_i2c_write
;	main.c:167: i2c_nack();
	lcall	_i2c_nack
;	main.c:168: restart_i2c();
	lcall	_restart_i2c
;	main.c:169: i2c_stop();
	lcall	_i2c_stop
;	main.c:210: }
